...
- `weekly-logs/` — Week-by-week write-ups of what I've learned and practiced
- `htb-writeups/` — Hack The Box machine write-ups (coming in Phase 3)
- `pentest-reports/` — Formal penetration test reports from my home lab
- `scripts/` — Python scripts and automation tools I've built

---

## 🛠️ Currently Learning

`Networking Basics` `Linux Command Line` `Kali Linux` `Wireshark` `Nmap`
